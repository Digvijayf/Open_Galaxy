...
export default function CertificatePage() {
  ...
  // Load certificate data from localStorage when component mounts
  useEffect(() => {
    ...
    if (storedData) {
      ...
      // Generate a random certificate ID if not loaded from localStorage
  ...
  return (
    <main className="max-w-4xl mx-auto p-4">
      ...
      {/* Certificate */}
      <div id="certificate-container" className="mb-10">
        {/* Set fixed A4 dimensions - 210mm x 297mm with proper print styling */}
        <div className="w-[210mm] h-[270mm] bg-white border-8 border-purple-900 p-6 mx-auto relative overflow-hidden print:border-8 print:border-purple-900 print:p-6">
          ...
          {/* Certificate border */}
          <div className="border-4 border-purple-200 h-full w-full p-6 relative">
            ...
            <div className="flex flex-col items-center justify-between h-full">
              ...
              <div className="text-center mb-4">
                <div className="flex justify-center items-center gap-4 mb-3">
                  <div className="w-14 h-14 relative bg-gray-200 rounded-full flex items-center justify-center">
                    <span className="text-xs text-gray-500">Logo</span>
                  </div>
                  <h1 className="text-3xl font-bold text-purple-900">OPEN GALAXY</h1>
                  <div className="w-14 h-14 relative bg-gray-200 rounded-full flex items-center justify-center">
                    <span className="text-xs text-gray-500">Logo</span>
                  </div>
                </div>
                <h2 className="text-xl font-semibold text-gray-600">Open Source Internship Program</h2>
              </div>

              {/* Certificate content - optimized spacing */}
              <div className="text-center flex-grow flex flex-col justify-center">
                <h2 className="text-xl text-gray-700 mb-1">This certificate is proudly presented to</h2>
                <h1 className="text-4xl font-bold text-purple-800 my-4 font-serif">{certificateData.recipientName}</h1>
                ...
                <div className="flex justify-center items-center gap-2 mb-6">
                  ...
                  <span className="text-lg font-semibold text-purple-800">CERTIFICATE OF ACHIEVEMENT</span>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="28"
                    height="28"
              ...
              <div className="w-full mt-5">
                <div className="flex justify-between items-end flex-wrap">
                  <div className="text-center">
                    <div className="w-40 border-t-2 border-gray-400 pt-1 mb-1"></div>
                    <p className="font-semibold">{certificateData.mentorName}</p>
                    <p className="text-xs text-gray-600">Program Mentor</p>
                  </div>
                ...
                <div className="mt-6 text-center">
                  <p className="text-xs text-gray-500">Certificate ID: OG-CERT-{certificateData.certificateId}</p>
                  <p className="text-xs text-gray-500">Verify this certificate at opengalaxy.example.com/verify</p>
                </div>
              </div>
            </div>
          </div>
